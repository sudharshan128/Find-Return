        ...
        <div className="card">
          ...
          <div className="space-y-3">
            ...
            <Link to="/admin/users?status=banned" className="btn btn-secondary w-full justify-start">
              <Ban className="w-5 h-5 mr-3 text-gray-600" />
              Banned Users
...
const AdminItems = () => {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-gray-900 mb-6">Items Management</h1>
        ...
        <table className="w-full">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-4 py-3 text-left text-sm font-semibold text-gray-900">Finder</th>
          ...
          <tbody className="divide-y divide-gray-200">
            {loading ? (
              ...
              items.map((item) => (
                <tr key={item.id} className={`hover:bg-gray-50 ${item.is_flagged ? 'bg-red-50' : ''}`}>
                  ...
                  <td className="px-4 py-3 text-sm text-gray-600">{item.finder?.full_name}</td>
                  <td className="px-4 py-3">
  ...
  return (
    <div>
      ...
      <div className="flex gap-2 mb-6">
        ...
        <span className="text-sm text-gray-500 ml-auto py-2">
        ...
        <table className="w-full">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-4 py-3 text-left text-sm font-semibold text-gray-900">Trust Score</th>
...
const AdminReports = () => {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-gray-900 mb-6">Abuse Reports</h1>
      ...
      {loading ? (
        ...
        <div className="card text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-1">No reports</h3>
