        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Help someone find their lost belongings by uploading details of the item you found.
            </p>
          </div>
            ...
            {step === 2 && (
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mb-4">
                    Provide details that will help the owner identify their item.
                  </p>
                </div>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Brand / Model <span className="text-gray-400">(optional)</span>
                  </label>
                  <input
                    type="text"
                    name="brand"
                    ...
                    onChange={handleInputChange}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                    placeholder="e.g., Samsung, Nike, Louis Vuitton"
                  />
                </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-amber-700 mb-2">
                        Ask a question only the true owner would know. This helps verify claims.
                      </p>
                      <input
                        type="text"
                        ...
                        className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent ${
                          errors.securityQuestion ? 'border-red-500' : 'border-amber-300'
                        }`}
                ...
                <div className="flex items-start gap-3 p-4 bg-red-50 rounded-lg border border-red-200">
                  ...
                  <div className="text-sm text-red-800">
                    <p className="font-medium mb-1">Do NOT include:</p>
            ...
            {step === 3 && (
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mb-4">
                    This helps owners narrow down their search.
                  </p>
                </div>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Area in Bangalore <span className="text-red-500">*</span>
                  </label>
                  <select
                    name="areaId"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Specific Location Details <span className="text-gray-400">(optional)</span>
                  </label>
                  <input
                    type="text"
                    ...
                    onChange={handleInputChange}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                    placeholder="e.g., Near Forum Mall entrance, Coffee shop near metro station"
                  />
                  <p className="mt-1 text-xs text-gray-500">
                    Be helpful but avoid sharing exact addresses for safety.
                  </p>
                </div>
                ...
                <div className="flex items-start gap-3 p-4 bg-blue-50 rounded-lg border border-blue-200">
                  ...
                  <p className="text-sm text-blue-800">
                    Items will automatically expire after 90 days if unclaimed.
                  </p>
                </div>
              </div>
            )}
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm text-yellow-800">
                      ...
                      <ul className="list-disc list-inside space-y-0.5">
                        ...
                        <li>Hide or blur any personal info visible on the item</li>
                        <li>First image will be the main display photo</li>
                        <li>Good lighting helps owners identify their items</li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {images[0] && (
                    <div className="relative h-48 bg-gray-100">
                      ...
                      />
                      <span className="absolute top-3 right-3 px-2 py-1 bg-white/90 rounded text-sm font-medium">
                  ...
                  <div className="p-4 space-y-4">
                    ...
                    <div className="pt-3 border-t border-gray-100 space-y-2">
                      ...
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <span className="text-gray-700">
                          Found on {new Date(formData.dateFound).toLocaleDateString('en-IN', {
                            day: 'numeric',
                            month: 'long',
                            year: 'numeric',
                          })}
                ...
                <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
                  <label className="flex items-start gap-3 cursor-pointer">
                    ...
                    <span className="text-sm text-gray-700">
                      I confirm that these details are accurate and I am genuinely trying to 
                      return this item to its rightful owner. I understand that misuse of this 
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm text-green-800">
                      ...
                      <ul className="space-y-1">
                        <li>• Your item will be visible to all users immediately</li>
                        <li>• Potential owners can submit claims with verification</li>
                        <li>• You'll review claims and approve the rightful owner</li>
            ...
            <div className="flex gap-3 mt-8 pt-6 border-t border-gray-200">
              {step > 1 && (
                <button
                  ...
                  onClick={prevStep}
                  disabled={submitting}
                  className="flex-1 px-4 py-3 border border-gray-300 rounded-lg font-medium text-gray-700 hover:bg-gray-50 transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
                >
              ...
              {step < 5 ? (
                <button
                  type="button"
                  onClick={nextStep}
                  className="flex-1 px-4 py-3 bg-primary-600 text-white rounded-lg font-medium hover:bg-primary-700 transition-colors flex items-center justify-center gap-2"
                >
                  Continue
                ...
                <button
                  ...
                  className="flex-1 px-4 py-3 bg-primary-600 text-white rounded-lg font-medium hover:bg-primary-700 transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {submitting ? (
                    <>
