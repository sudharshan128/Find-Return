          ...
          <div>
              ...
              {item.area && (
                <div className="flex items-center gap-2 text-gray-600">
                  ...
                  {item.location_details && (
                    <span className="text-gray-400">• {item.location_details}</span>
                  )}
                </div>
              )}
            ...
            {item.finder && (
              <div className="bg-gray-50 rounded-xl p-4 mb-6">
                <h3 className="font-semibold text-gray-900 mb-3">Found by</h3>
                <div className="flex items-center gap-3">
                  ...
                  />
                  <div>
                    <p className="font-medium text-gray-900">{item.finder.full_name}</p>
